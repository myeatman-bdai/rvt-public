...
from rvt.utils.get_dataset_real_liv import get_dataset_real
...
def experiment(rank, cmd_args, devices, port):
    ...
    NUM_TRAIN = cmd_args.num_train_demos
    ...
    t_start = time.time()
    get_dataset_func = lambda: get_dataset_real(
        tasks,
        BATCH_SIZE_TRAIN,
        None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-train-demos", type=int, default=100)

    parser.add_argument("--liv-dir", default=None)
